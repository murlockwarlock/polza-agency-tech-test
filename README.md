...
- Однозначные city aliases приводятся к каноническим значениям, исходная строка остаётся в `raw_payload`.
